	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		...
		switch ( $icon ) {
			case 'moon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'basetheme' ) ) . '</title>';
				}
			...
			case 'sun':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'basetheme' ) ) . '</title>';
				}
			...
			case 'settings':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Settings', 'basetheme' ) ) . '</title>';
				}
			...
			case 'home':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Home', 'basetheme' ) ) . '</title>';
				}
				$output .= '<path d="M9.984 20.016h-4.969v-8.016h-3l9.984-9 9.984 9h-3v8.016h-4.969v-6h-4.031v6z"></path>
				</svg>';
				break;
			case 'search':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . 'id="Layer_1" data-name="Layer 1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 979.99 979.9">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'basetheme' ) ) . '</title>';
				}
				$output .= '<g id="search">
			...
			case 'zoom':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Zoom In', 'basetheme' ) ) . '</title>';
				}
			...
			case 'bag':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bag', 'basetheme' ) ) . '</title>';
				}
			...
			case 'facebook':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'basetheme' ) ) . '</title>';
				}
			...
			case 'twitter':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'basetheme' ) ) . '</title>';
				}
			...
			case 'tiktok':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'TikTok', 'basetheme' ) ) . '</title>';
				}
			...
			case 'discord':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discord', 'basetheme' ) ) . '</title>';
				}
			...
			case 'instagram':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'basetheme' ) ) . '</title>';
				}
			...
			case 'vimeo':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Vimeo', 'basetheme' ) ) . '</title>';
				}
			...
			case 'youtube':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'basetheme' ) ) . '</title>';
				}
			...
			case 'github':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'basetheme' ) ) . '</title>';
				}
			...
			case 'rss':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'basetheme' ) ) . '</title>';
				}
			...
			case 'facebook_group':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook Group', 'basetheme' ) ) . '</title>';
				}
			...
			case 'dribbble':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dribbble', 'basetheme' ) ) . '</title>';
				}
			...
			case 'xing':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Xing', 'basetheme' ) ) . '</title>';
				}
			...
			case 'wordpress': // phpcs:ignore WordPress.WP.CapitalPDangit.Misspelled
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WordPress', 'basetheme' ) ) . '</title>';
				}
			...
			case 'whatsapp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WhatsApp', 'basetheme' ) ) . '</title>';
				}
			...
			case 'vk':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'VK', 'basetheme' ) ) . '</title>';
				}
			...
			case 'tumblr':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Tumblr', 'basetheme' ) ) . '</title>';
				}
			...
			case 'reddit':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'basetheme' ) ) . '</title>';
				}
			...
			case 'patreon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Patreon', 'basetheme' ) ) . '</title>';
				}
			...
			case 'medium':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Medium', 'basetheme' ) ) . '</title>';
				}
			...
			case 'behance':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Behance', 'basetheme' ) ) . '</title>';
				}
			...
			case 'anchor':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Anchor', 'basetheme' ) ) . '</title>';
				}
			...
			case 'soundcloud':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'basetheme' ) ) . '</title>';
				}
			...
			case 'email':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'basetheme' ) ) . '</title>';
				}
			...
			case 'phone':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'basetheme' ) ) . '</title>';
				}
			...
			case 'google_reviews':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Google Reviews', 'basetheme' ) ) . '</title>';
				}
			...
			case 'telegram':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'basetheme' ) ) . '</title>';
				}
			...
			case 'trip_advisor':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Trip Advisor', 'basetheme' ) ) . '</title>';
				}
			...
			case 'yelp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Yelp', 'basetheme' ) ) . '</title>';
				}
			...
			case 'user':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'User', 'basetheme' ) ) . '</title>';
				}
			...
			case 'comments':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'basetheme' ) ) . '</title>';
				}
			...
			case 'folder':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Categories', 'basetheme' ) ) . '</title>';
				}
			...
			case 'grid':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'basetheme' ) ) . '</title>';
				}
			...
			case 'list':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'List', 'basetheme' ) ) . '</title>';
				}
				$output .= '<path d="M1 3h14v3h-14zM1 7h14v3h-14zM1 11h14v3h-14z"></path>
				</svg>';
				break;
			case 'account':
				$output .= '<svg id="Layer_1" data-name="Layer 1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980 980">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'basetheme' ) ) . '</title>';
				}
				$output .= '<path d="M652.4,524.5C729,474.5,780,388.4,780,290,780,135.4,654.6,10,500,10S220,135.4,220,290c0,98.4,51,184.5,127.6,234.5C151.7,588.6,10,772.7,10,990H80c0-231.9,188.1-420,420-420S920,758.1,920,990h70C990,772.7,848.3,588.6,652.4,524.5ZM290,290c0-116,94-210,210-210s210,94,210,210S616,500,500,500,290,406,290,290Z" transform="translate(-10 -10)"/>
				</svg>';
				break;
			case 'account2':
			...
			case 'pinterest':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'basetheme' ) ) . '</title>';
				}
			...
			case 'mobile':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Mobile', 'basetheme' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'hours':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'basetheme' ) ) . '</title>';
				}
			...
			case 'location':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'basetheme' ) ) . '</title>';
				}
			...
			case 'envelop':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Envelop', 'basetheme' ) ) . '</title>';
				}
			...
			case 'linkedin':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'basetheme' ) ) . '</title>';
				}
			...
			case 'goodreads':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Goodreads', 'basetheme' ) ) . '</title>';
				}
			...
			case 'amazon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Amazon', 'basetheme' ) ) . '</title>';
				}
			...
			case 'bookbub':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'BookBub', 'basetheme' ) ) . '</title>';
				}
			...
			case 'quotes':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Quotes', 'basetheme' ) ) . '</title>';
				}
			...
			case 'arrow-left':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'basetheme' ) ) . '</title>';
				}
			...
			case 'arrow-right':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Next', 'basetheme' ) ) . '</title>';
				}
			...
			case 'arrow-right-alt':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Continue', 'basetheme' ) ) . '</title>';
				}
			...
			case 'arrow-down':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Expand', 'basetheme' ) ) . '</title>';
				}
			...
			case 'arrow-up':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'basetheme' ) ) . '</title>';
				}
			...
			case 'chevron-up2':
				...
				break;
			case 'menu':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="thebase-svg-icon thebase-menu-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'basetheme' ) ) . '</title>';
				}
			...
			case 'listFilter':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'basetheme' ) ) . '</title>';
				}
			...
			case 'close':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'basetheme' ) ) . '</title>';
				}
			...
			case 'shopping-bag':
				...
				width="512.000000pt" height="512.000000pt" fill="currentColor" viewBox="0 0 512.000000 512.000000"
				preserveAspectRatio="xMidYMid meet">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'basetheme' ) ) . '</title>';
				}
				$output .= '<g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
				fill="currentColor">
				...
				break;
			case 'shopping-cart':
				$output .= '<svg class="thebase-svg-icon thebase-shopping-cart-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'basetheme' ) ) . '</title>';
				}
			...
			case 'apple_podcasts':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Podcasts', 'basetheme' ) ) . '</title>';
				}
			...
			case 'spotify':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Spotify', 'basetheme' ) ) . '</title>';
				}
			...
			case 'flickr':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Flicker', 'basetheme' ) ) . '</title>';
				}
			...
			case '500px':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( '500PX', 'basetheme' ) ) . '</title>';
				}
			...
			case 'bandcamp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bandcamp', 'basetheme' ) ) . '</title>';
				}
			...
			case 'imdb':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'IMDB', 'basetheme' ) ) . '</title>';
				}
			...
			case 'spinner':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Loading', 'basetheme' ) ) . '</title>';
				}
			...
			case 'check':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Done', 'basetheme' ) ) . '</title>';
				}
			...
			case 'checkbox':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'basetheme' ) ) . '</title>';
				}
			...
			case 'disc':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Disc', 'basetheme' ) ) . '</title>';
				}
